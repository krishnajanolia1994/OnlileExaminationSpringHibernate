...
<body >
 ...
 <header>
  ...
  <h1>
    ...
    <div class="radio">
      <label><input type="radio" name="subject_name" value="<%= (Add_subject)session.getAttribute(j+"Avalable_Subject").teacher_id %>"><%= (Add_subject)session.getAttribute(j+"Avalable_Subject").subject %> </label>
    </div>
    <% } %>
   	<div class=radio>
   	<input type="submit">
